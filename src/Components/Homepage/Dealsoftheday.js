    ...
    <div className="flex justify-center bg-[#F6F6F6] py-10">
      <div className="w-10/12 flex justify-between">
        ...
        <div className="flex space-x-28">
          <div className="relative bg-white font-light py-3 pl-3 shadow-slate-600 shadow-lg">
          ...
          <div className="relative bg-white py-3 font-light shadow-slate-600 shadow-lg">
          ...
          <div className="relative bg-white py-3 pr-4 font-light shadow-slate-600 shadow-lg">
